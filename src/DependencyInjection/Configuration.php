        ...
        $treeBuilder
            ->getRootNode()
                ->children()
                    ...
                    ->end()
                    ->scalarNode('api_time_zone')
                        ->info('The time zone of the CO instance, used for timestamp conversion')
                    ...
                    ->arrayNode('internal')
                        ...
                        ->children()
                            ...
                            ->booleanNode('cache')
                                ...
                                ->example('true')
                            ->end()
                            ->integerNode('incremental_sync_threshold')
                                ->defaultValue(200)
                                ->info('threshold for when to force a full sync')
                            ->end()
                        ->end()
                    ->end()
                ->end()
